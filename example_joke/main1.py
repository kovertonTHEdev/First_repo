...
def main(): # Вона спочатку запитує у користувача ім'я, а потім вітає його.
    ...
    while True: # цикл while True, програма запитує у користувача, чи хоче він почути анекдот
...
if __name__ == "__main__": # перевіряє, чи запускається файл безпосередньо, а не імпортується як модуль, і тільки в цьому випадку викликає
    main()
